...
def init_denoise_wf(bids_dir,
    ...
    iterate = ['fmri_prep', 'fmri_prep_aroma', 'conf_prep', 'entities']
...
if __name__ == '__main__':  # TODO Move parser to module __main__
    ...
    logging.critical("Please invoke denoise at module level by using: \n \
        python -m Restingfmri_Denoise \n \
        python Restingfmri_Denoise \n \
        python ${path_to_directory}/Restingfmri_Denoise/__main__.py \n \
    ...
    bids_dir = '/Users/xiaoqian/projects/denoise_data/BIDS_Testing'
    ...
    wf = init_RestingfmriDenoise_wf(bids_dir, subject=['01', '02'], task=['rest'], session=['1'], smoothing=True, ica_aroma=True)
